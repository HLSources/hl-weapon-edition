...
private:
	...
	void		 CreateBuyMenu( void );
	CMenuPanel*		 ShowBuyMenu( void );
	CMenuPanel*		 ShowSellMenu( void );
	CMenuPanel*		 ShowFullMenu( void );

	void		 CreateJoinMenu( void );
	CMenuPanel*		 ShowTMenu( int PC, int PK );
	CMenuPanel*		 ShowJoinMenu( int PC, int PK );// team menu + class menu
	CMenuPanel*		 ShowUnlockMenu( int PC, int PK );
...
public:
	...
	void ShowVGUIMenu( int iMenu, int PC = 0, int PK = 0 );
	...
	int MsgFunc_JoinMenu(const char *pszName, int iSize, void *pbuf );
